...
<template>
  ...
  <div class="container mx-auto p-4 mt-48 dm_sans">
    ...
    <h3 class="text-center gradient_nusantara dark:text-gray-200 text-6xl mt-3 font-normal">Leader of <span class="nusantara_text font-semibold bg-gradient-to-r from-red-500 to-white bg-clip-text text-transparent">Nusantara</span> Programmer</h3>
