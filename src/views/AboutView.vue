...
<template>
  <div class="dm_sans shadow_collor">
    ...
    <div class="ClassName test_gradient_backgorund mt-36 flex bg-gray-200 dark:bg-gray-900 rounded-3xl items-center justify-around">
      <div class="ClassName">
        ...
        <div class="flex space-x-6 justify-start mt-10">
          <div class="p-2 dark:bg-gray-800 rounded-full hover:scale-110 duration-100">
            <facebookIco />
          </div>
          <div class="p-2 dark:bg-gray-800 rounded-full hover:scale-110 duration-100">
            <Insta />
    ...
    <section>
      <div class="other_gallery_card mt-96" style="margin-top: 600px">
        <!-- //galely grid square -->
        ...
        <div class="flex flex-wrap gap-10 mx-auto justify-center mt-10 rounded-3xl">
          <div class="w-full sm:w-10 md:w-32 lg:w-40 xl:w-72 p-4">
            <img class="rounded-full asset_profile hover:scale-105 duration-100" src="../assets/img/zet.jpg" alt="" />
          ...
          <div class="w-full sm:w-10 md:w-32 lg:w-40 xl:w-72 p-4">
            <img class="rounded-full asset_profile hover:scale-105 duration-100" src="../assets/img/akaksayangg.png" alt="" />
            <div class="text-center mt-5">
              <h3 class="text-3xl font-medium">Im Zet</h3>
              <p class="mt-3 text-sm dark:text-gray-400">Frontend Developer</p>
            </div>
    ...
    <section class="ClassName icon_framework_about mt-20">
      <div class="container p-6 mx-auto space-y-6 text-center lg:p-8 lg:space-y-8">
        <div class="flex flex-wrap justify-center lg:justify-between mt-10">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Gatsby" class="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 dark:text-gray-400">
            <title>Gatsby</title>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Nuxt.js" class="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 dark:text-gray-400">
            <title>Nuxt.js</title>
            <path
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Svelte" class="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 dark:text-gray-400">
            <title>Svelte</title>
            <path
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Vue.js" class="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 dark:text-gray-400">
            <title>Vue.js</title>
    ...
    <section class="p-6 mt-10 dark:text-gray-200">
      <div class="flex coloumn_rate items-center p-10 bg-gray-900 rounded-3xl">
        ...
        <div class="container_rate mx-auto grid justify-center grid-cols-2 text-center lg:grid-cols-3">
          <div class="flex flex-col justify-start m-2 lg:m-6 shadow-2xl">
          ...
          <div class="flex flex-col justify-start m-2 lg:m-6 shadow-xl">
