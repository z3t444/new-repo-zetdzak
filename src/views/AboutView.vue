...
<template>
  <div class="dm_sans shadow_collor">
    ...
    <div class="flex hero_about flex-col justify-between items-center sm:flex-row mt-40 gap-10">
    ...
    <div class="ClassName mt-28 p-5 pb-0">
        ...
        <div class="w-full md:w-1/2 p-4 margin_state">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
            <div class="grid grid-cols-1 gap-6">
              <div class="p-6 rounded-3xl flex space-x-3 dark:border dark:border-gray-800 hover:scale-105 hover:bg-gray-900 duration-100">
                <Discord />
                <div>
      ...
      <div class="container px-5 mx-auto">
        ...
        <div class="flex flex-wrap -m-2">
          <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
            <div class="h-full flex items-center dark:border-gray-800 dark:bg-gray-900 hover:bg-transparent border p-4 rounded-2xl hover:scale-105 duration-100">
